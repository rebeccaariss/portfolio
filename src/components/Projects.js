  ...
  return (
    <section id='projects'>
      <section id='matchymatchy'>
        ...
        <br></br>
        <a href='https://github.com/rebeccaariss/matchy-matchy' target='blank' rel='noopener noreferrer' alt='Karity GitHub Repo'>
          <img src={matchyMatchyDemo} alt='matchy matchy Demo'/>
        </a>
        <br></br>
        <p>🚧 <em>Work in progress</em> 🚧 <br></br><br></br>A minimalist and nostalgic card-matching game featuring some of my favourite emojis. You can follow along for progress updates in my dev log <a href='https://github.com/rebeccaariss/matchy-matchy/blob/main/README.md' target='blank' rel='noopener noreferrer' alt='matchy matchy README'>here!</a></p>
      </section>
